...
class OrderResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->persistFiltersInSession()->persistSortInSession()->persistSearchInSession()->persistColumnSearchesInSession()->persistColumnsInSession()->columns([
            ...
            Action::make('confirm_order_disabled')
                ->label('Confirm order')
                ->icon('heroicon-m-shield-check')
                ->disabled()
                ->tooltip('Invalid pending/confirmed admin mutation was removed. Use the canonical Order Engine lifecycle and dispatch workflow.'),
