...
class WorkerSettlementRuleResource extends Resource
{
    ...
    public static function canAccess(): bool { return auth()->user()?->can('admin.finance.view') ?? false; }
    public static function canCreate(): bool { return auth()->user()?->can('admin.finance.manage') ?? false; }
