...
class OrdersHub extends AdminOsModulePage
{
    ...
    private function base(): Builder { return Order::with(['scenario','customer','priceQuotes','dispatchAssignments.assignedUser.workerProfile','dispatchAssignments.assignedUser.workerAvailability','dispatchEvents','supportTickets.assignee','workerLocationPings','completionProofs.events','events']); }
