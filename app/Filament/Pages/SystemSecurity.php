...
class SystemSecurity extends AdminOsModulePage
{
    ...
    public function getOperationalModules(): array
    {
        ...
        return [
            ...
            $this->status('Support Center', \App\Models\SupportTicket::count().' ticket(s)', 'Order-linked ticket core, timeline, assignments and Admin OS resource are configured. Account/worker portals and external notifications are deferred.', $this->routeAvailable('filament.admin.resources.support-tickets.index') ? 'configured' : 'blocked', $this->routeAvailable('filament.admin.resources.support-tickets.index') ? route('filament.admin.resources.support-tickets.index') : ''),
