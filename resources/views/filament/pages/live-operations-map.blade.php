...
layer(sessionStorage.getItem('bkb-map-layer')||d.default_layer||'standard');setTimeout(()=>map.invalidateSize(),100);window.addEventListener('resize',()=>map.invalidateSize());document.querySelectorAll('[data-layer]').forEach(b=>b.addEventListener('click',()=>!b.disabled&&layer(b.dataset.layer)));
