...
(function(){
 ...
 const refresh=()=>map.invalidateSize(); requestAnimationFrame(refresh); setTimeout(refresh,100); setTimeout(refresh,350); setTimeout(refresh,800); window.addEventListener('resize',refresh);
