...
<style>
html,body{overflow:hidden!important}body.worker-dashboard-mapfirst{background:#06111e}body.worker-dashboard-mapfirst .worker-shell{display:block;min-height:100dvh}body.worker-dashboard-mapfirst .worker-sidebar,body.worker-dashboard-mapfirst .worker-topbar,body.worker-dashboard-mapfirst .worker-bottom{display:none!important}body.worker-dashboard-mapfirst .worker-main{display:block;min-height:100dvh}body.worker-dashboard-mapfirst .worker-content{padding:0!important;min-height:100dvh}.wv2{position:fixed;inset:0;width:100vw;height:100dvh;overflow:hidden;background:#06111e}.wv2-map-stage,.wv2-map{position:absolute;inset:0;width:100%;height:100%;min-width:0;min-height:0}.wv2-map{z-index:1}.leaflet-container{background:#06111e;color:#dce9f6;overflow:hidden!important}.leaflet-pane,.leaflet-tile,.leaflet-marker-icon,.leaflet-marker-shadow,.leaflet-tile-container,.leaflet-pane>svg,.leaflet-pane>canvas,.leaflet-zoom-box,.leaflet-image-layer,.leaflet-layer{position:absolute!important;left:0;top:0}.leaflet-container img.leaflet-tile{max-width:none!important;max-height:none!important;width:256px!important;height:256px!important;display:block!important}.leaflet-tile{filter:brightness(.72) saturate(.84) contrast(1.12) hue-rotate(156deg)}.leaflet-tile-pane{z-index:200}.leaflet-overlay-pane{z-index:400}.leaflet-marker-pane{z-index:600}.leaflet-control-container{position:absolute;inset:0;z-index:800;pointer-events:none}.leaflet-control{pointer-events:auto}.wv2-vignette{position:absolute;inset:0;z-index:2;pointer-events:none;background:linear-gradient(180deg,rgba(3,10,18,.50),transparent 18%,transparent 62%,rgba(3,10,18,.70)),radial-gradient(circle at 14% 18%,rgba(var(--brand-rgb),.14),transparent 28%)}.wv2-appbar{position:absolute;z-index:20;top:max(.55rem,env(safe-area-inset-top));left:.65rem;right:.65rem;display:flex;align-items:center;justify-content:space-between;gap:.5rem;pointer-events:none}.wv2-glass{pointer-events:auto;border:1px solid rgba(148,163,184,.12);background:rgba(5,14,25,.58);backdrop-filter:blur(18px);box-shadow:0 12px 36px rgba(0,0,0,.18)}.wv2-brand{display:flex;align-items:center;gap:.5rem;border-radius:999px;padding:.34rem .58rem;text-decoration:none}.wv2-logo{display:grid;place-items:center;width:30px;height:30px;border-radius:999px;background:linear-gradient(135deg,var(--brand-a),var(--brand-b));color:#03130d;font-weight:950}.wv2-brand strong{display:block;font-size:.78rem;line-height:1}.wv2-brand small{display:block;color:var(--muted);font-size:.58rem;font-weight:850}.wv2-nav{display:flex;gap:.16rem;border-radius:999px;padding:.25rem}.wv2-nav a{display:flex;align-items:center;gap:.28rem;border-radius:999px;padding:.42rem .62rem;color:#dbe8f6;text-decoration:none;font-weight:900;font-size:.72rem}.wv2-nav a.is-active{background:rgba(var(--brand-rgb),.13);color:var(--green)}.wv2-presence{display:flex;align-items:center;gap:.42rem;border-radius:999px;padding:.42rem .62rem;color:var(--green);font-weight:950;font-size:.78rem}.wv2-presence-dot{width:.48rem;height:.48rem;border-radius:999px;background:var(--green);box-shadow:0 0 12px rgba(var(--brand-rgb),.75)}.wv2-state-card{position:absolute;z-index:12;top:4.6rem;left:.75rem;width:min(24rem,calc(100vw - 1.5rem));border-radius:22px;padding:.82rem;pointer-events:none}.wv2-kicker{margin:0;color:var(--green);font-size:.62rem;font-weight:950;letter-spacing:.12em;text-transform:uppercase}.wv2-state-card h2{margin:.03rem 0;font-size:clamp(2.3rem,4.5vw,4.1rem);line-height:.86;letter-spacing:-.07em}.wv2-primary{display:inline-flex;margin:.5rem 0 0;padding:.58rem .72rem;border-radius:14px;background:rgba(var(--brand-rgb),.12);border:1px solid rgba(var(--brand-rgb),.22);color:#e7fff4;font-size:.93rem;font-weight:950}.wv2-status-pill{position:absolute;z-index:12;right:.75rem;top:4.6rem;display:flex;align-items:center;gap:.5rem;border-radius:999px;padding:.48rem .66rem;font-weight:900;font-size:.76rem;color:#dbe8f6}.wv2-status-pill b{color:var(--green)}.wv2-sheet{position:absolute;z-index:16;left:.75rem;bottom:max(5.55rem,calc(env(safe-area-inset-bottom) + 5.55rem));width:min(25rem,calc(100vw - 1.5rem));border-radius:22px;padding:.75rem}.wv2-sheet h3{margin:.1rem 0;font-size:1rem}.wv2-sheet p{margin:.28rem 0 0;color:var(--muted);font-size:.84rem}.wv2-sheet-actions{display:flex;gap:.45rem;margin-top:.62rem}.wv2-bottom{position:absolute;z-index:18;left:50%;bottom:max(.7rem,env(safe-area-inset-bottom));transform:translateX(-50%);width:min(390px,calc(100vw - 1.4rem));border-radius:24px;padding:.68rem}.wv2-bottom.is-waiting{opacity:.86}.wv2-swipe{position:relative;user-select:none;touch-action:none;overflow:hidden;border:1px solid rgba(var(--brand-rgb),.32);border-radius:999px;background:rgba(3,12,22,.92);height:62px;display:flex;align-items:center;padding:6px}.wv2-swipe.is-offline{border-color:rgba(251,113,133,.34)}.wv2-swipe-track{position:absolute;inset:0;display:grid;place-items:center;font-weight:950;color:#eff6ff;letter-spacing:.02em}.wv2-swipe-knob{position:relative;z-index:2;width:50px;height:50px;border-radius:999px;border:0;background:linear-gradient(135deg,var(--brand-a),var(--brand-b));color:#fff;font-size:1.1rem;font-weight:950;box-shadow:0 12px 34px rgba(var(--brand-rgb),.28);cursor:grab}.wv2-swipe.is-offline .wv2-swipe-knob{background:linear-gradient(135deg,#fb7185,#b91c1c)}.wv2-swipe-status{margin:.36rem 0 0;font-size:.72rem;color:var(--muted);text-align:center}.wv2-live-btn{min-height:38px;border-color:rgba(85,217,255,.35);background:rgba(85,217,255,.10)}.wv2-mobile-nav{position:absolute;z-index:30;left:.55rem;right:.55rem;bottom:max(.45rem,env(safe-area-inset-bottom));display:none;grid-template-columns:repeat(5,1fr);gap:.25rem;border-radius:22px;padding:.32rem}.wv2-mobile-nav a{display:flex;flex-direction:column;align-items:center;gap:.08rem;border-radius:15px;padding:.42rem .2rem;text-decoration:none;color:#dbe8f6;font-size:.62rem;font-weight:850}.wv2-mobile-nav a.is-active{background:rgba(var(--brand-rgb),.12);color:var(--green)}.wv2-marker-worker,.wv2-marker-last,.wv2-marker-stop{display:grid;place-items:center;width:30px;height:30px;border-radius:999px;color:#03120d;font-weight:950}.wv2-marker-worker{background:var(--green);box-shadow:0 0 0 10px rgba(var(--brand-rgb),.18),0 0 34px rgba(var(--brand-rgb),.5)}.wv2-marker-last{background:#55d9ff}.wv2-marker-stop{background:#f5bd54}.wv2-zone-label{font-size:.76rem;font-weight:950;color:#dce9f6;text-shadow:0 2px 8px #000}.leaflet-control-zoom{margin-right:.8rem!important;margin-bottom:5.6rem!important}.leaflet-control-attribution{max-width:45vw;overflow:hidden;white-space:nowrap}@media(max-width:920px){.wv2-nav a span{display:none}.wv2-state-card{top:4.25rem;width:min(21rem,calc(100vw - 1.5rem))}.wv2-state-card h2{font-size:3rem}.wv2-status-pill{top:4.25rem}.wv2-sheet{bottom:5.35rem}.leaflet-control-zoom{display:none}}@media(max-width:680px){.wv2-brand strong,.wv2-brand small,.wv2-nav{display:none}.wv2-appbar{top:.45rem;left:.5rem;right:.5rem}.wv2-brand{padding:.34rem}.wv2-state-card{top:3.95rem;left:.55rem;right:.55rem;width:auto;padding:.68rem}.wv2-state-card h2{font-size:2.45rem}.wv2-primary{font-size:.84rem}.wv2-status-pill{top:auto;right:.55rem;bottom:9.25rem}.wv2-sheet{left:.55rem;right:.55rem;bottom:9.3rem;width:auto;padding:.62rem}.wv2-bottom{left:.55rem;right:.55rem;bottom:4.85rem;transform:none;width:auto;padding:.58rem}.wv2-mobile-nav{display:grid}.leaflet-control-attribution{display:none}}
</style>
@endpush
