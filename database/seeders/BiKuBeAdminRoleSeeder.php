...
class BiKuBeAdminRoleSeeder extends Seeder
{
    private const ROLE_PERMISSIONS = [
        ...
        'finance' => ['admin.dashboard.view', 'admin.orders.view', 'admin.finance.view', 'admin.finance.manage', 'admin.finance.payment_actions', 'admin.finance.refunds', 'admin.finance.provider_settings', 'admin.billing.view', 'admin.billing.manage', 'admin.payments.view', 'admin.payments.manage', 'admin.payments.provider_actions', 'admin.payments.webhooks.view'],
    ...
    private const PERMISSIONS = [
        ...
        'admin.finance.payment_actions', 'admin.finance.refunds', 'admin.finance.provider_settings',
        'admin.billing.view', 'admin.billing.manage', 'admin.payments.view', 'admin.payments.manage',
        'admin.payments.provider_actions', 'admin.payments.webhooks.view',
